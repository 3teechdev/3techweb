...
const Hero = () => {
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center bg-gradient-subtle w-full"
    >
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          {/* Top Badge */}
          <div className="inline-flex items-center bg-white/10 px-4 py-2 rounded-full mb-8 animate-shimmer">
            <Code2 className="h-4 w-4 text-[#E5E7EB]" />
            <span className="text-sm font-medium text-[#E5E7EB] ml-2">
          ...
          {/* Buttons */}
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-16 animate-scale-in">
            <Link to="/contact" className="w-90 sm:w-auto">
              <button className="flex items-center justify-center text-lg bg-[#1E3A8A] text-white px-6 py-3 rounded-lg shadow-lg hover:bg-[#1E40AF] hover:scale-105 transition-transform w-full sm:w-auto">
                Get Started <ArrowRight className="ml-2 h-5 w-5" />
              </button>
            </Link>
            <Link to="/projects" className="w-90 sm:w-auto">
              <button className="text-lg border border-[#E5E7EB] text-[#E5E7EB] px-6 py-3 rounded-lg hover:bg-[#E5E7EB]/10 hover:border-[#E5E7EB] hover:shadow-lg transition-all w-full sm:w-auto">
                View Projects
              </button>
            </Link>
          </div>
      ...
      <div className="m-0 p-0 text-[#f5f5f7]">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-[#f5f5f7] via-[#cfd6e3] to-[#f5f5f7] bg-clip-text text-transparent animate-fade-in">
              Why Choose Us
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={index}
                  className="p-6 rounded-2xl bg-white/10 border border-[#cfd6e3]/30 hover:border-[#a8b1c0] hover:shadow-lg transition-all duration-500 animate-slide-up hover:scale-105"
                  style={{ animationDelay: `${index * 0.2}s` }}
                >
                  <div className="mb-4 animate-float">{feature.icon}</div>
                  <h3 className="text-xl sm:text-2xl font-semibold mb-3 text-[#f5f5f7]">
                    {feature.title}
                  </h3>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-[#1e293b] via-[#273449] to-[#1e293b] rounded-xl shadow-xl">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold mb-6 text-[#f5f5f7] animate-fade-in">
              Ready to Start Your Project?
            </h2>
            <p className="text-lg sm:text-xl mb-8 text-[#cfd6e3]/90 max-w-2xl mx-auto">
              Let's bring your ideas to life with cutting-edge technology and
              exceptional design.
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 flex-wrap">
              <Link to="/contact" className="w-full sm:w-auto">
                <button className="flex items-center justify-center bg-[#cfd6e3] text-[#1e293b] font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-[#e0e5ed] hover:scale-105 transition-transform w-full sm:w-auto">
                  Get in Touch <ArrowRight className="ml-2 h-5 w-5" />
                </button>
              </Link>
              <Link to="/projects" className="w-full sm:w-auto">
                <button className="border border-[#cfd6e3] text-[#cfd6e3] px-6 py-3 rounded-lg hover:bg-[#cfd6e3]/10 hover:border-[#cfd6e3] hover:shadow-lg transition-all w-full sm:w-auto">
                  View Our Work
                </button>
              </Link>
            </div>
